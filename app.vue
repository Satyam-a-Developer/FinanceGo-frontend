<template>
  <div>
    <nav :class="[
      ...
      <div ref="navRef" :class="[
        ...
        <div :class="[
          ...
          <div :class="[
            ...
            <NuxtLink to="/" class="flex items-center space-x-2 text-white relative nav-link"
              :class="{ 'active-link': route.path === '/' }">
              <span>Home</span>
            </NuxtLink>
            <NuxtLink to="/pricing" class="flex items-center space-x-2 text-white relative nav-link"
              :class="{ 'active-link': route.path === '/pricing' }">
              <span>Pricing</span>
            </NuxtLink>
            <NuxtLink to="/Dashboard" class="flex items-center space-x-2 text-white relative nav-link"
              :class="{ 'active-link': route.path === '/Dashboard' }" @click="toggleDashboard">
              <span>Dashboard</span>
            </NuxtLink>
      ...
      <div v-if="mobileMenuOpen" class="md:hidden absolute top-full left-0 right-0 bg-[#14213d]/90 p-4 space-y-4">
        <NuxtLink to="/" class="block text-white hover:text-blue-500 transition nav-link"
          :class="{ 'text-blue-500': route.path === '/' }">
          Home
        </NuxtLink>
        <NuxtLink to="/features" class="block text-white hover:text-blue-500 transition nav-link"
          :class="{ 'text-blue-500': route.path === '/features' }">
          Features
        </NuxtLink>
        <NuxtLink to="/pricing" class="block text-white hover:text-blue-500 transition nav-link"
