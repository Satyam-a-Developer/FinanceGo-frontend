        ...
        return {
            ...
            boxes: [
                ...
                },
                {
                    title: "Period",
                    dataKey: "period",
                    class: "bg-gradient-to-br from-blue-300 to-blue-700",
                },
                {
                    title: "Expected Income",
                    dataKey: "expectedIncome",
                    class: "bg-gradient-to-t from-sky-400 to-blue-500",
                },
                {
                    title: "Actual Income",
                    dataKey: "actualIncome",
                    class: "bg-gradient-to-bl from-blue-500 to-blue-900",
                },
                {
                    title: "Reason",
                    dataKey: "reason",
                    class: "bg-gradient-to-r from-cyan-300 via-blue-400 to-blue-600",
                },
                {
                    title: "Category",
                    dataKey: "category",
                    class: "bg-gradient-to-tl from-indigo-400 via-blue-500 to-sky-300",
                },
            ],
            chartData: {
                labels: [
    ...
    methods: {
        async getAIPrediction() {
            ...
            try {
                ...
                this.aiResponse =
                    "Sorry, I encountered an error while generating the prediction. Please try again.";
            } finally {
        ...
        async fetchBusinessData() {
            try {
                const response = await fetch(
                    "http://localhost:3003/dashboard/business",
                    {
                        method: "GET",
                        credentials: "include",
                    },
                ...
                if (response.ok) {
                    ...
                    throw new Error(
                        data.error || "Failed to fetch business data",
                    );
                }
            } catch (error) {
